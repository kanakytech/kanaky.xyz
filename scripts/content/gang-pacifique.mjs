  ...
  body: [
    ...
    { table: {
      ...
      rows: [
        ...
        ['Un workflow automatisé', 'équivalent 1 000 – 4 000 €'],
        ['Système IA local sur votre matériel', 'sur devis, matériel inclus'],
        ['Accompagnement mensuel', 'équivalent 100 – 500 €/mois'],
      ],
    }},
    'Le travail se livre à distance, donc les fourchettes sont proches de celles de Nouvelle-Calédonie — voir [le détail des prix](/prix-automatisation-ia-nouvelle-caledonie/). Ce qui change ici : la pertinence d’une installation locale, et le fait qu’avec peu de concurrence, **vous devez être d’autant plus exigeant sur ce qu’on vous vend.**',
  ...
  body: [
    ...
    { table: {
      ...
      rows: [
        ...
        ['Local AI system on your own hardware', 'Quoted, hardware included'],
        ['Ongoing support', 'Monthly, scoped'],
      ],
    }},
    'Work is delivered remotely, so ranges sit close to New Caledonia. What differs here is how strongly local deployment is favoured — and that with little competition, **you should be more demanding, not less**, about what you are sold.',
