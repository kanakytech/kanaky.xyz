...

{
  ...
  published: '2026-07-28', modified: '2026-09-23',
  extraGraph: [{
    '@type': 'LocalBusiness', '@id': 'https://kanaky.xyz/#business',
    name: 'Kanaky Tech — Auckland',
    url: 'https://kanaky.xyz/ai-automation-agency-auckland/',
    image: '/assets/kanaky-tech-logo.jpg',
    parentOrganization: { '@id': 'https://kanaky.xyz/#organization' },
    address: { '@type': 'PostalAddress', addressLocality: 'Auckland', addressCountry: 'NZ' },
    telephone: '+64223716309', email: 'kevyn@kanaky.xyz', priceRange: '$$', currenciesAccepted: 'NZD, AUD, USD',
  ...
  body: [
    ...
    { table: {
      ...
      rows: [
        ...
        ['Software you run yourself', 'From US$999, bought once'],
      ],
    }},
    ...
    { h: 'Inspect the work before choosing a provider' },
    'Our [public projects](/case-studies/) and [open-data integration](/mcp-datagouvnc/) let you inspect what we build. These are engineering examples, not evidence of savings for your business. For your pilot, record the current handling time, weekly volume and error rate; then compare the same measures after deployment, including time spent reviewing AI output.',
    ...
    'Being in Auckland means overlapping working hours, ability to sit in your office, and understanding the market — that a Kiwi tradie quotes differently from an American contractor, and that "she\'ll be right" is not a documentation strategy when a compliance auditor arrives.',
    ...
    { note: 'We work from Auckland, Aotearoa, across New Zealand and the wider Pacific — including [Kanaky (New Caledonia)](/ai-automation-new-caledonia/), Tahiti, Wallis and Futuna and Réunion, in French where that is the working language.' },
  ],
  faq: [
    ...
    { q: 'How much does AI automation cost in New Zealand?', a: 'A single automated workflow typically lands in the low four figures; a custom AI agent connected to your systems, mid four figures. The audit is free. If your need is outbound prospecting specifically, software you buy once from US$999 and run yourself is usually the better value than an agency engagement.' },
  ...
  related: [
    ['/ai-automation-gold-coast/', 'AI automation for Gold Coast businesses'],
    ['/ai-automation-new-zealand/', 'AI automation across Aotearoa'],
...

{
  ...
  description: 'AI automation for Australian small businesses, delivered remotely with overlapping working hours: what we automate, honest pricing against the AU market, Spam Act compliance built in, and when not to hire anyone.',
  ...
  body: [
    ...
    'We work remotely from Auckland, Aotearoa — same working day as the east coast, two or three hours ahead, depending on daylight saving. We will not sit in your Sydney office, and an agency that does has a genuine advantage for a large, complex rollout. What remote delivery changes is the cost base: no city office is priced into your invoice, which is why a single automated workflow lands in the low four figures rather than the tens of thousands typical of the Australian mid-market.',
    ...
    { list: [
      ...
      '**Outbound prospecting** — the [AI Sales Rep](/marketplace/cold-outreach-machine/) runs on your own hardware, is bought once at US$999, and enforces the mechanics the [Spam Act 2003](/cold-email-law-australia/) requires: identification, functional unsubscribe, permanent opt-outs.',
    ]},
...

{
  ...
  title: 'AI Automation for Gold Coast Businesses | Kanaky Tech',
  description: 'AI automation for Gold Coast trades, marine and tourism businesses. Enquiries, quote preparation and booking workflows, delivered remotely from Auckland. Free audit.',
  eyebrow: 'Gold Coast · Remote delivery', short: 'AI automation · Gold Coast',
  h1: 'AI automation for Gold Coast businesses.', cta: 'service',
  extraGraph: [{ '@type': 'Service', '@id': 'https://kanaky.xyz/ai-automation-gold-coast/#service', name: 'AI automation for Gold Coast businesses', serviceType: 'Business process automation and custom AI agents', provider: { '@type': 'Organization', '@id': 'https://kanaky.xyz/#organization', name: 'Kanaky Tech', url: 'https://kanaky.xyz/' }, areaServed: { '@type': 'City', name: 'Gold Coast', containedInPlace: { '@type': 'State', name: 'Queensland' } }, availableChannel: { '@type': 'ServiceChannel', serviceUrl: 'https://kanaky.xyz/contact/' } }],
  body: [
    { lead: 'Kanaky Tech builds AI agents and workflow automation for Gold Coast businesses, delivered remotely from Auckland, Aotearoa. Start with one repetitive process: incoming enquiries, quote preparation, booking administration or document handling. We scope the work and agree a price before development. We do not have a Gold Coast office.' },
    { h: 'Three practical starting points' },
    { h3: 'Trades: prepare a quote without losing the evening' },
    'A plumber or builder receives a voice note, photos and a job address. A workflow can gather these into a job record, flag missing details and prepare a draft from an approved price list. The owner checks scope, travel, materials and margin before sending. Success means less preparation time per quote without more corrections. See [AI for builders](/ai-for-builders/).',
    { h3: 'Marine: organise service enquiries before booking work' },
    'A boat owner supplies a vessel model, engine details and a fault description across several messages. A workflow can consolidate the record, request missing information and route it to the right person. A technician makes the diagnosis and confirms parts and availability. This is an intake workflow, not an autonomous safety assessment. See [AI for marine businesses](/ai-for-marine-businesses/).',
    { h3: 'Tourism and hospitality: answer accurately, then hand over' },
    'An accommodation or activity operator can draft answers from its approved policies and booking data. The system should hand over exceptions, refunds and uncertain answers. Weather-dependent activities need an operator decision; an AI response must not invent availability or confirm a departure without authorisation. See [AI for hospitality](/ai-for-hospitality/).',
    { note: 'These are proposed workflow designs. They are not claims about completed Gold Coast client projects or guaranteed savings.' },
    { h: 'What the first engagement includes' },
    { steps: ['A free remote audit: map one process, the tools involved and the time currently spent.', 'A written scope: inputs, outputs, human approvals, integrations, acceptance criteria and a fixed project quote.', 'A pilot using agreed examples, including missing information, duplicate requests and service outages.', 'A documented handover: how to run it, correct a mistake, pause it and take ownership. Support and recurring provider costs are agreed separately.'] },
    { h: 'Budget and return: make the calculation visible' },
    'The quote depends on the integrations, data preparation, review requirements and deployment environment. Confirm the currency, any applicable tax, setup fees, hosting, AI usage and support before committing. Existing software may already solve the problem; the audit should identify that too.',
    'For illustration only: 40 requests a week with six minutes of net handling time saved per request would release four hours a week. Measure net time after human checking and corrections. This is a calculation to test in a pilot, not a forecast of your result.',
    { h: 'Working together across the Tasman' },
    'Delivery, training and support are remote. Gold Coast uses Queensland time; Auckland is two or three hours ahead depending on the season. Meeting invitations specify the time zone and date. If your project requires on-site hardware installation, agree a local delivery arrangement before proceeding.',
    { h: 'Data handling and sources to check' },
    'Before connecting live customer data, document which fields leave each system, which providers receive them, where they are processed, who has access and how they are deleted. An Australian hosting region alone does not establish that every integration stays in Australia. Use the [OAIC guidance on AI products](https://www.oaic.gov.au/privacy/privacy-guidance-for-organisations-and-government-agencies/guidance-on-privacy-and-the-use-of-commercially-available-ai-products) to frame the privacy review. For outbound messaging, check [ACMA guidance on avoiding spam](https://www.acma.gov.au/avoid-sending-spam) before enabling a campaign.',
    { h: 'Public work you can inspect' },
    'Explore our [open-data integration](/mcp-datagouvnc/) and [project portfolio](/case-studies/). These demonstrate implementation work; they do not substitute for testing your own workflow. Ask for a demonstration using a non-sensitive sample of your actual process.',
  ],
  faq: [
    { q: 'Is Kanaky Tech based on the Gold Coast?', a: 'No. Kanaky Tech is based in Auckland, Aotearoa, and serves Gold Coast businesses remotely. There is no Gold Coast office.' },
    { q: 'Can you automate quoting and booking enquiries?', a: 'Yes, subject to the tools and data available. A pilot can collect information, draft responses and prepare records. Pricing decisions, exceptions and final commitments remain with the authorised person unless a specific approval policy is agreed.' },
    { q: 'How much does a project cost?', a: 'The initial audit is free. Implementation is quoted against an agreed scope. The proposal separates setup from recurring hosting, AI usage and support, and states the currency and applicable tax.' },
    { q: 'Can we keep our existing business software?', a: 'Usually the aim is to connect existing tools. API access, permissions and export capabilities are checked during scoping. We identify limitations before committing to an integration.' },
  ],
  related: [['/ai-audit/', 'Start with a free audit'], ['/ai-automation-australia/', 'Automation for Australian businesses'], ['/ai-automation-agency-auckland/', 'Our Auckland base'], ['/automatisation-ia-tahiti/', 'Services for Tahiti']],
},
];
