...

{
  ...
  title: 'Commercial IA : logiciel de prospection payé une fois | Kanaky Tech',
  description: 'Un commercial IA acheté une fois, pas un abonnement : il trouve les entreprises qui correspondent à vos clients idéaux, écrit un message différent pour chacune et les envoie seul, à un rythme qui protège votre domaine. Code source inclus, appel d’installation, 30 jours de support.',
  ...
  eyebrow: 'Produit',
  short: 'Commercial IA',
  ogTitle: 'Commercial IA — recruté une fois, à vous pour toujours',
  h1: 'Recrutez un commercial une fois. <span style="color:var(--grey-4);font-weight:300;">Gardez-le pour toujours.</span>',
  cta: 'service-fr',
  /* date de la page en prod : sans elle, chaque build la rajeunissait */
  published: '2026-08-13',
  extraGraph: [{
    '@type': 'Product',
    '@id': 'https://kanaky.xyz/machine-prospection-commerciale/#produit',
    name: 'Commercial IA — prospection commerciale automatisée',
    ...
    description: 'Commercial IA vendu une fois, sans abonnement. Il identifie les entreprises correspondant au profil de client décrit, lit ce que chacune publie, rédige un message différent par entreprise et les envoie à un rythme espacé pendant les heures ouvrées. Tourne sur votre propre machine ; la rédaction peut passer par un fournisseur IA ou tourner entièrement en local.',
  ...
  body: [
    ...
    { table: {
      ...
      rows: [
        ['Prix', '**999 USD** — environ **103 000 F CFP**, une fois', '39 à 97 USD **par mois**'],
        ['Ce que vous achetez', 'La recherche, la lecture de chaque entreprise et la rédaction — le travail lui-même', 'L’envoi. La liste et les textes restent à votre charge'],
